        ...
        if(this.switchBoardURI !== null){
            ...
            for (let i = 0; i < 20; i++) {
                try{
                    ...
                    console.error(`      ...: ${err}. Interrupting process of starting up one2manyMo script on port ${_roomId * 1000 + 100 + i * 10}.`);
                }
            }
            for (let i = 0; i < 10; i++) {
                try{
                ...
                try{
                    ...
                    console.error(`      ...: ${err}. Interrupting process of starting up one2manyBi script on port ${_roomId * 1000 + 300 + i * 10}.`);
                }
            }
        ...
        if(this.switchBoardURI !== null) {
            ...
            for (let i = 0; i < 20; i++) {
                try{
                    ...
                    console.error(`      ...: ${err}. Interrupting process of stopping one2manyMo script on port ${_roomId * 1000 + 100 + i * 10}.`);
                }
            }
            for (let i = 0; i < 10; i++) {
                try{
                ...
                try{
                    ...
                    console.error(`      ...: ${err}. Interrupting process of stopping one2manyBi script on port ${_roomId * 1000 + 300 + i * 10}.`);
                }
            }
